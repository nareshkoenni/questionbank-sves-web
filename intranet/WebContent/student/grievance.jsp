...
<div class="single">
	<div class="container">
		...
		<br>
<form action="http://intranet.bvrithyderabad.edu.in:9000/intranet/sgcs?rollnumber=<%=rollnumber%>" name="grievance" method="post" >
	...
	<table align="center">	
		<tr><td>&nbsp;</td></tr>
		<tr>
			<td><input type="text" placeholder="mail ID" value="<%=rollnumber%>@bvrithyderabad.edu.in"  name="mailID" class="form-control" required="required"/></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		...
		<tr>
			<td><input type="hidden"  name="rollnumber" value="<%=rollnumber%>" class="form-control"/></td>	
		</tr>
