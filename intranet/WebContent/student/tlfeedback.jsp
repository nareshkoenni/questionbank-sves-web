...
<form action="http://intranet.bvrithyderabad.edu.in:9000/intranet/student/tlfeedback1.jsp" name="postattendance" method="post">
	...
	<table align="center">	
		...
		<tr>
			<td>Feedback Num</td>
			<td><select name="fbnum" required="required" class="btn btn-default dropdown-toggle">
