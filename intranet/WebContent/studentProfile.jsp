...
function getStudentDetails() {
	var rollno=document.getElementById("user").value;
	  if (rollno === "") {
        ...
        xmlhttp.open("GET","getStudentProfile.jsp?rollnumber="+rollno,true);
        xmlhttp.send();
    }
}
function userValid(){
...
<h3 align="center" class="bars">Student Profile</h3><br>
...
<br/>
		<div id="studentInfo" align="center"><b>Student Profile will be displayed here...</b><br/>
