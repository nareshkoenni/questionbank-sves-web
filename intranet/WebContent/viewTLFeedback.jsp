...
function showReport(str) {
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","http://intranet.bvrithyderabad.edu.in:9000/intranet/tlFeedbackReport.jsp?branch="+branch+"&sem="+sem+"&section="+section+"&course="+course+"&ay="+ay,true);
        xmlhttp.send();
    }
}
function showCustomer() {
	...
	option.text=a[i].toString();
	  ...
	  xhttp.open("GET", "http://intranet.bvrithyderabad.edu.in:9000/intranet/student/getStudentCourses.jsp?branch="+branch+"&sem="+sem+"&section="+section, true);
	  xhttp.send();
	}
</script>
</head>
...
<form action="http://intranet.bvrithyderabad.edu.in:9000/intranet/sendASMS1.jsp?uid=<%=uid%>" name="postattendance" method="post">
	<br>
	<h3 align="center" class="bars">Teaching Learning Feedback Report </h3><br>
		<table align="center">	
		...
		<tr>
			...
			<td><input type="button" value="Get Course" onclick="showCustomer()" ></td>		
		</tr>
		<tr>
			<td>Course</td>
