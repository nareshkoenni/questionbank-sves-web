...
<form action="http://intranet.bvrithyderabad.edu.in:9000/intranet/sendSMSSS1.jsp?uid=<%=uid%>" name="postattendance" method="post">
	<h3 align="center" class="bars">SMS to Specific Student</h3><br>
