...
<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/tdemes/smootdness/jquery-ui.css">
...
<h3 align="center" class="bars">Leave Summary</h3>
	...
	%> 
			...
			<%} %>
				<td align="center"><a href="updateLeaveSummary.jsp?lsId=<%=rs.getString("lsid")%>">update</a></td>
