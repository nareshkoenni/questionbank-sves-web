...
<h3 class="bars" align="center">SMS to Specific Student </h3>  <h5 align="center" style="font: bold;">Note: Check the Roll Numbers to send SMS &nbsp;&nbsp;&nbsp;<input type="checkbox" onClick="toggle(this)" /> Check All </h5>
<form action="sendSMSSS2.jsp" name="postattendance" method="post">
