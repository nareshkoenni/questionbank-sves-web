...
<tr valign=top>
<td style="border:none"><img src="images/clg.png" width="600" height="95" ></td>
 
</tr>

</table><hr>
<form action="ams" method="post">
<h2 align="center" style="color: blue;">Add Marks</h2>
	<table align="center">	
	<tr>
			<td>Course</td>
			<td><select name="course">
				<option value="btech">B.Tech</option></select>
		</tr>
		<tr>
			<td>Semester</td>
			<td><select name="sem" >
