...
function showReport(str) {
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","smsReport2.jsp?date="+date,true);
        xmlhttp.send();
    }
}
</script>
...
<form action="http://intranet.bvrithyderabad.edu.in:9000/intranet/sendASMS1.jsp?uid=<%=uid%>" name="report" method="post">
	...
	<table align="center">	
		...
		<tr>
			<td><input type="text"  name="date" placeholder="click" id="datepicker" class="form-control"/></td>	
